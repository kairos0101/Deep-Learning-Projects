...
class ImageClassifierHelper(
    ...
    var currentModel: Int = MODEL_MOBILENETV2_MAIN_62,
    ...
    fun setupImageClassifier() {
        ...
        val modelName =
            when (currentModel) {
                //MODEL_MOBILENET_V2 -> "mobilenet_v2.tflite"
                //MODEL_MOBILENET_V2_KERAS -> "mobilenet_v2_keras.tflite"
                //MODEL_EFFICIENTNETLITE0 -> "efficientnetlite0.tflite"
                //MODEL_EFFICIENTNETLITE2 -> "efficientnetlite2.tflite"
                //MODEL_EFFICIENTNETLITE4 -> "efficientnetlite4.tflite"
                //MODEL_MOBILENET_V2_MAIN -> "MOBILENET_V2-main.tflite"
                //MODEL_MOBILENET_V2_INT8 -> "MOBILENET_V2-int8.tflite"
                //MODEL_MOBILENET_V2_KERAS_MAIN -> "MOBILENET_V2_KERAS-main.tflite"
                //MODEL_MOBILENET_V2_KERAS_INT8 -> "MOBILENET_V2_KERAS-int8.tflite"
                //MODEL_EFFICIENTNETLITE0_MAIN -> "EFFICIENTNET_LITE0-main.tflite"
                //MODEL_EFFICIENTNETLITE0_INT8 -> "EFFICIENTNET_LITE0-int8.tflite"
                //MODEL_EFFICIENTNETLITE2_MAIN -> "EFFICIENTNET_LITE2-main.tflite"
                //MODEL_EFFICIENTNETLITE2_INT8 -> "EFFICIENTNET_LITE2-int8.tflite"
                //MODEL_EFFICIENTNETLITE4_MAIN -> "EFFICIENTNET_LITE4-main.tflite"
                //MODEL_EFFICIENTNETLITE4_INT8 -> "EFFICIENTNET_LITE4-int8.tflite"
                //MODEL_MV2_KERAS_INT8 -> "MV2_KERAS-int8.tflite"
                //MODEL_MV2_KERAS_MAIN -> "MV2_KERAS-main.tflite"

                MODEL_MOBILENETV2_INT8 -> "MobileNetV2_48mins-int8.tflite"
                MODEL_MOBILENETV2_MAIN -> "MobileNetV2_48mins-main.tflite"
                //MODEL_MOBILENETV2_KERAS_INT8 -> "MobileNetV2_Keras_70mins-int8.tflite"
                //MODEL_MOBILENETV2_KERAS_MAIN -> "MobileNetV2_Keras_70mins-main.tflite"
                MODEL_EFFICIENTNET_LITE0_INT8 -> "EFFICIENTNET_LITE0_49mins-int8.tflite"
                MODEL_EFFICIENTNET_LITE0_MAIN -> "EFFICIENTNET_LITE0_49mins-main.tflite"
                MODEL_MOBILENETV2_INT8_62 -> "MOBILENETV2_1hr26mins3s-int8.tflite"
                MODEL_MOBILENETV2_MAIN_62 -> "MOBILENETV2_1hr26mins3s-main.tflite"
                MODEL_EFFICIENTNET_LITE0_INT8_62 -> "EFFICIENTNETLITE0_1hr6mins0s-int8.tflite"
                MODEL_EFFICIENTNET_LITE0_MAIN_62 -> "EFFICIENTNETLITE0_1hr6mins0s-main.tflite"

                else -> "MOBILENETV2_1hr26mins3s-main.tflite"
            }
    ...
    companion object {
        ...
        //const val MODEL_MOBILENET_V2_INT8 = 0
        //const val MODEL_MOBILENET_V2_KERAS_INT8 = 1
        //const val MODEL_EFFICIENTNETLITE0_INT8 = 2
        //const val MODEL_EFFICIENTNETLITE2_INT8 = 3
        //const val MODEL_EFFICIENTNETLITE4_INT8 = 4
        //const val MODEL_MV2_KERAS_INT8 = 5
        //const val MODEL_MV2_KERAS_MAIN = 6

        const val MODEL_MOBILENETV2_INT8 = 0
        const val MODEL_MOBILENETV2_MAIN = 1
        //const val MODEL_MOBILENETV2_KERAS_INT8 = 2
        //const val MODEL_MOBILENETV2_KERAS_MAIN = 3
        const val MODEL_EFFICIENTNET_LITE0_INT8 = 2
        const val MODEL_EFFICIENTNET_LITE0_MAIN = 3
        const val MODEL_MOBILENETV2_INT8_62 = 4
        const val MODEL_MOBILENETV2_MAIN_62 = 5
        const val MODEL_EFFICIENTNET_LITE0_INT8_62 = 6
        const val MODEL_EFFICIENTNET_LITE0_MAIN_62 = 7

        const val MAX_RESULTS_DEFAULT = 5

        //const val MODEL_MOBILENET_V2 = 0
        //const val MODEL_MOBILENET_V2_KERAS = 1
        //const val MODEL_EFFICIENTNETLITE0 = 2
        //const val MODEL_EFFICIENTNETLITE2 = 3
        //const val MODEL_EFFICIENTNETLITE4 = 4
        //const val MODEL_MOBILENET_V2_MAIN = 5
        //const val MODEL_MOBILENET_V2_KERAS_MAIN = 7
        //const val MODEL_EFFICIENTNETLITE0_MAIN = 9
        //const val MODEL_EFFICIENTNETLITE2_MAIN = 11
        //const val MODEL_EFFICIENTNETLITE4_MAIN = 13
